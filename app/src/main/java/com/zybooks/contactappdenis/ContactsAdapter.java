...
class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> {
    ...
    public ContactsAdapter(Context context, ArrayList<ContactsModel> contactsModalArrayList) {
        this.context = context;
        this.contactsModelArrayList = contactsModalArrayList;
    }
    ...
    public ContactsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ContactsAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.contacts_rv_item, parent, false));
    ...
    public void onBindViewHolder(@NonNull ContactsAdapter.ViewHolder holder, int position) {
        // getting data from array list in our model.
        ContactsModel model = contactsModelArrayList.get(position);
        // on below line we are setting data to our text view.
        holder.contactTV.setText(model.getUserName());
        ...
        TextDrawable drawable2 = TextDrawable.builder().beginConfig()
                ...
                .buildRound(model.getUserName().substring(0, 1), color);
