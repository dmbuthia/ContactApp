...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareContactRV() {
        ...
        contactsAdapter = new ContactsAdapter(this, contactsModalArrayList);
    ...
    // below is the show setting dialog method which is use to display a dialogue message.
    ...
    private void getContacts() {
        // this method is use to read contact from users device. on below line we are creating a string variables for
...
//                        contactsModalArrayList.add(new ContactsModel(displayName, phoneNumber));
//                    }
